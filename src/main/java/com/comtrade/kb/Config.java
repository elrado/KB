...
@ComponentScan("com.comtrade.kb.dao")
public class Config {
	...
	public DataSource dataSource() {
		...
		dataSource.setUrl("jdbc:h2:file:d:/Delo/Sw/Java/KnowledgeDB;DB_CLOSE_ON_EXIT=FALSE");
		return dataSource;
	}//end datasource		
	...
	Properties hibernateProperties() {
		...
		properties.setProperty("connection.url", "jdbc:h2:file:d:/Delo/Sw/Java/KnowledgeDB;DB_CLOSE_ON_EXIT=FALSE");
